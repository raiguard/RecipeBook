...
function slot_table.build(parent, context, title, members, remark)
  ...
  local frame = outer.add({ type = "frame", style = "slot_button_deep_frame" })
  -- frame.style.horizontally_stretchable = true
  local tbl = frame.add({ type = "table", style = "slot_table", column_count = 10 })
