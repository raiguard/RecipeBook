recipe_book.set_alternative(data.raw["curved-rail-a"]["curved-rail-a"], data.raw["straight-rail"]["straight-rail"])
recipe_book.set_alternative(data.raw["curved-rail-b"]["curved-rail-b"], data.raw["straight-rail"]["straight-rail"])
