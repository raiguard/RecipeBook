...
recipe_book.set_exclude(data.raw["recipe"]["electric-energy-interface"], true)
recipe_book.set_exclude(data.raw["item"]["electric-energy-interface"], true)
recipe_book.set_exclude(data.raw["electric-energy-interface"]["electric-energy-interface"], true)
