...
function technology_page.build()
  local elems =  {
    ...
    info_list_box.build({"rb-gui.unlocks-fluids"}, 1, {"technology", "unlocks_fluids"}),
    info_list_box.build({"rb-gui.unlocks-items"}, 1, {"technology", "unlocks_items"}),
...
function technology_page.update(int_name, gui_data, player_data)
  ...
  return
    ...
    + info_list_box.update(obj_data.unlocks_fluids, refs.technology.unlocks_fluids, player_data)
    + info_list_box.update(obj_data.unlocks_items, refs.technology.unlocks_items, player_data)
