...
constants.gui_strings = {
  ...
  {dictionary = "gui", internal = "captions", localised = {"gui.rb-captions"}},
  {dictionary = "gui", internal = "category", localised = {"gui.rb-category"}},
  {dictionary = "gui", internal = "click", localised = {"gui.rb-click"}},
  {dictionary = "gui", internal = "close_search_gui_after_selection", localised = {"gui.rb-close-search-gui-after-selection"}},
  {dictionary = "gui", internal = "close_search_when_moving_info_pages", localised = {"gui.rb-close-search-when-moving-info-pages"}},
  ...
  {dictionary = "gui", internal = "content", localised = {"gui.rb-content"}},
  ...
  {dictionary = "gui", internal = "fuzzy_search", localised = {"gui.rb-fuzzy-search"}},
  ...
  {dictionary = "gui", internal = "preserve_search_query", localised = {"gui.rb-preserve-search-query"}},
  ...
  {dictionary = "gui", internal = "search_gui_location", localised = {"gui.rb-search-gui-location"}},
  {dictionary = "gui", internal = "search", localised = {"gui.rb-search"}},
  {dictionary = "gui", internal = "search_type", localised = {"gui.rb-search-type"}},
  ...
  {dictionary = "gui", internal = "show_alternate_name", localised = {"gui.rb-show-alternate-name"}},
  {dictionary = "gui", internal = "show_descriptions", localised = {"gui.rb-show-descriptions"}},
  {dictionary = "gui", internal = "show_detailed_tooltips", localised = {"gui.rb-show-detailed-tooltips"}},
  {dictionary = "gui", internal = "show_disabled", localised = {"gui.rb-show-disabled"}},
  {dictionary = "gui", internal = "show_fluid_temperatures", localised = {"gui.rb-show-fluid-temperatures"}},
  {dictionary = "gui", internal = "show_glyphs", localised = {"gui.rb-show-glyphs"}},
  ...
  {dictionary = "gui", internal = "tooltips", localised = {"gui.rb-tooltips"}},
