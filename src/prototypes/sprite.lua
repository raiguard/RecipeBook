...
data:extend{
  ...
  -- TODO: proper icon for pause
  data_util.build_sprite("rb_pause_black", {0, 96}, frame_action_icons, 32),
  data_util.build_sprite("rb_pause_white", {32, 96}, frame_action_icons, 32),
  -- tool icons
